...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-i5fnhg4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-i5fnhg4.containers.anotherwebservice.com/
...
```
git clone git@github.com:np4abdou/container-i5fnhg4.git
cd container-i5fnhg4
```
...
```
docker attach container-i5fnhg4
```
